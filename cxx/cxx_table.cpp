...
// static method
int Db::open(const char *fname, BERKLEYDB_DB_TYPE type, u_int32_t flags,
...
// static method
int Db::xa_open(const char *fname, BERKLEYDB_DB_TYPE type, u_int32_t flags,
...
BERKLEYDB_DB_TYPE Db::get_type() const
{
    const DB *db = unwrapConst(this);
    return db->type;
}
